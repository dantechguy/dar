Terminology:
- Scene Tree -- High level tree of objects, modifiers and groups. Declarative interface used by programmer
- Scene Item
- Process Tree -- Middle level tree of objects and groups, where sorting of tris happens
- Process Item
- Render List -- Low level list of render items, to be directly translated into Canvas instructions
- Render Item
